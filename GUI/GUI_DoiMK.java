...
//				tfNLMKM.setText("Nhập lại mật khẩu mới");
		...
		btnTD.setForeground(new Color(249, 224, 187));
		btnTD.setFont(new Font("Tahoma", Font.PLAIN, 14));
		btnTD.setBackground(new Color(17, 57, 70));
		...
		btnTrlai.setFont(new Font("Tahoma", Font.PLAIN, 14));
